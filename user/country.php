...
function geolocate() {
 ...
 <!--
 	API AIzaSyCeqf-bvx4tEASK4BPjifd7Q2Rwe_KIhWU
 	closest thing############
<script>
...
$(document).on('change', '#'+searchInput, function () {
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCeqf-bvx4tEASK4BPjifd7Q2Rwe_KIhWU&libraries=places&callback=activatePlacesSearch"
        async defer></script>
  </body>
</html>
